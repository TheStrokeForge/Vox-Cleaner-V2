...
'''
VoxCleaner V2 © 2022 by Farhan Shaikh is licensed under GNU GPLv3.


You can contact me on Instagram/Twitter @TheStrokeForge or visit my website https://www.thestrokeforge.xyz for any details.

Thanks so much for your purchase and please feel free to tag if you use VoxCleaner! I’d love to see your work! 
Cheers!
            ...
            for area in screen.areas:
                for space in area.spaces:
                    if space.type == 'IMAGE_EDITOR':
                        space.uv_editor.pixel_snap_mode = 'CORNER'
